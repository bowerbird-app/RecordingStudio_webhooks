...
configure a callable that accepts a attempt ID and optional schedule.
...
Schedule `dispatch_due` through the host scheduler. It reconciles attempts left
...
The engine does not delete endpoint, event, or attempt records automatically.
